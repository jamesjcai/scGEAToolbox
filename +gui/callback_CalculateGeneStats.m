function callback_CalculateGeneStats(src, ~)
    ...
    gui.i_exporttable(T, true, 'GeneStatsTable');
...
- **Error Handling:** Consider adding error handling around calls to user dialog boxes and functions like `sc_genestats`.
- **User Feedback:** Provide visual feedback (e.g., progress bars or messages) during long-running operations.
- **Testing:** Add unit tests for individual components of the function to ensure reliability.
