function callback_KO2x2Analysis(src, ~)
    ...
    for k = 1:4
        for l = k+1:4
            ...
            sce1 = sce1.qcfilter;
            sce2 = sce.selectcells(c==l);
            sce2 = sce2.qcfilter;

            [Tdv] = gui.e_dvanalysis_splinefit(sce1, sce2, {cL1}, {cL2});
            in_processTdv(Tdv, cL1, cL2);
        end
    end
    ...
    function in_processTdv(T, cL1, cL2)
        [T] = pkg.in_DVTableProcess(T, cL1, cL2);
        Tup = T(T.DiffSign > 0, :);
        Tdn = T(T.DiffSign < 0, :);
        outfile = sprintf('%s_vs_%s_KO2x2_DV_results', ...
    ...
    function in_processTde(T, cL1, cL2)
        [T] = pkg.in_DETableProcess(T, cL1, cL2);
        ...
        outfile = sprintf('%s_vs_%s_KO2x2_DE_results', ...
            matlab.lang.makeValidName(string(cL1)), ...
            matlab.lang.makeValidName(string(cL2)));
