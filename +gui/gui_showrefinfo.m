...
switch reftag
    ...
    case 'GCL Analysis [PMID:33139959]'
        txt=['"The GCL analysis measures the average multivariate ' ...
            'dependency between expression levels of random gene ' ...
            'subsets of single cells. To calculate the GCL, we ' ...
            'first divide the genes into two random subsets. ' ...
            'Then we measure the dependency level between the ' ...
            'two subsets over a cohort of cells."'];

    case 'talklr [DOI:10.1101/2020.02.01.930602]'
        txt=['"...we developed talklr, an information theory-based ' ...
            'approach to uncover potential ligand-receptor ' ...
            'interactions involved in tissue homeostasis ' ...
            'and diseases. Compared to existing approaches ' ...
            'that analyze changes in each gene in each cell ' ...
            'type separately, talklr uses a holistic approach' ...
            ' to simultaneously consider expression changes in ' ...
            'both ligands and receptors across multiple cell ' ...
            'types and conditions."'];
    case 'PanglaoDB [PMID:30951143]'
        txt=['"The ''PanglaoDB'' database of cell type markers was ' ...
             'compiled by manual curation of thousands of published ' ...
            'articles and abstracts, and by querying internet search ' ...
            'engines ... To determine the cell type of a cell cluster, ' ...
            'we perform the following steps: for every cell cluster ' ...
            'k in a sample s, we iterate over all genes i=1...N and ' ...
    ...
    case 'Differentiation Potency [PMID:33244588]'
        txt='"An important task in the analysis of single-cell RNA-Seq data is the estimation of differentiation potency, as this can help identify stem-or-multipotent cells in non-temporal studies or in tissues where differentiation hierarchies are not well established. ... Here, we present a single-cell potency measure, called Correlation of Connectome and Transcriptome (CCAT), which can return accurate single-cell potency estimates of a million cells in minutes, a 100-fold improvement over current state-of-the-art methods."';
    case 'Other Predefined Cell Score'
