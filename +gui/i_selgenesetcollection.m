...
if selectedindx == 6, return; end              % '---------------------------' separator
if selectedindx == 3, speciesid = 'human'; return; end  % 'Glycobiology Gene Sets'
if selectedindx == 5, speciesid = 'human'; return; end  % 'Predefined Custom Gene Sets'
