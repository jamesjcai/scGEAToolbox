classdef myFigure < handle
    ...
    methods
        ...
        function obj = myFigure()
            ...
            obj.tbv{5} = pkg.i_addbutton2fig(obj.tb, 'off', {@gui.i_pickmonocolor, true}, 'color-wheel.jpg', 'Pick a New Colormap...');
            ...
            obj.tbv{11} = pkg.i_addbutton2fig(obj.tb, 'on', {@gui.i_resizewin, obj.FigureHandle}, 'scale-frame-reduce.jpg', 'Resize Plot Window');
        end
