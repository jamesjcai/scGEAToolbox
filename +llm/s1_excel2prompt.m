...
prompt1 = "enrichr is a gene function enrichment analysis service. " + ...
    "I will give you an output of enrichr analysis below. Please " + ...
    "summarize the results in text. The results mixed enriched terms " + ...
