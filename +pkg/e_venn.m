function [S, D] = e_venn(a,b)

%a="CTNNBIP1, KIAA2013, NBL1, SYF2, YRDC, S100A6, S100A2, PCYOX1, MAT2A, RNF181, COA5, NCBP2, SCARB2, VDAC1, RNF145, SLU7, DEK, HLA-A, GPANK1, BAK1, HMGN3, ASCC3, WDR45, HRAS, CHID1, PXMP2, STUB1, BFAR, USB1, MAP1LC3B, SUPT4H1, UBALD2, NSFL1C, SNRPB2, ATXN10";
%b="ALDOA, C4BPB, CBX3, CCDC80, CYP1B1, DBI, EMP1, FADS2, FGFR1, HMGA1, MCAM, PABPC3, PPIA, S100A6, SCD, SLC3A2, SLC7A5, TGM2, TPM1, TUBB6,";
%b="DTYMK, EMP1, ENO1, FTH1, HMGA1, HMGB2, HNRNPA2B1, HSP90AA1, IGFBP3, ITGA6, LGALS3, MALAT1, NUCKS1, S100A6, SLC7A5, SMC4, TACSTD2, TGM2, TPM1, TUBA1B,";
...
function hCirc = drawCircles(hParent, xc, yc, r, P, V)
    ...
    for i = 1:n
        ...
        hCirc(i) = patch (xx, yy, cx(i), 'FaceAlpha', fa{i}, 'Parent', hParent, 'Tag', tag{i});
        if i==1
