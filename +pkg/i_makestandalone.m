...
addpath(wrkpth);
wrkpth = fullfile(pw1, '+run', 'external', 'ml_PHATE');
addpath(wrkpth);
wrkpth = fullfile(pw1, '+run', 'external', 'ml_UMAP44');
addpath(wrkpth);
wrkpth = fullfile(pw1, '+run', 'external', 'ml_SIMLR');
addpath(wrkpth);
wrkpth = fullfile(pw1, '+run', 'external', 'ml_SIMLR', 'src');
addpath(wrkpth);
wrkpth = fullfile(pw1, '+run', 'external', 'ml_CSN_transform');
addpath(wrkpth);
wrkpth = fullfile(pw1, '+run', 'external', 'ml_Specter');
addpath(wrkpth);
wrkpth = fullfile(pw1, '+run', 'external', 'ml_Specter', 'dimred');
addpath(wrkpth);
wrkpth = fullfile(pw1, '+run', 'external', 'ml_Specter', 'LSC');
addpath(wrkpth);
wrkpth = fullfile(pw1, '+run', 'external', 'ml_Specter', 'utils');
addpath(wrkpth);
wrkpth = fullfile(pw1, '+run', 'external', 'ml_SoptSC');
addpath(wrkpth);
wrkpth = fullfile(pw1, '+run', 'external', 'ml_SoptSC', 'NNDSVD');
addpath(wrkpth);
wrkpth = fullfile(pw1, '+run', 'external', 'ml_SoptSC', 'symnmf2');
addpath(wrkpth);
wrkpth = fullfile(pw1, '+run', 'external', 'ml_SinNLRR');
addpath(wrkpth);
wrkpth = fullfile(pw1, '+run', 'external', 'ml_SNNDPC');
addpath(wrkpth);
