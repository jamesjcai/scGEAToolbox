...
%   License: BSD 3 clause
    ...
    methods
        ...
        function [names, clrs, map]=getMatchedNames(this)
            if isempty(this.matchedNames)
                [names, clrs, sIds]=LabelBasics.NamesAndColors(...
                    this.qf.sIdPerRow(:,1), this.idMap);
                map=Map;
                matchNames=QfHiDM.GetMatchingNamesAndColors(this.qf, this.idMap);
        ...
        function showDecisionMatrix(this, doOverlap, forBrowser)
            if nargin<3
                forBrowser=false;
            end
            ...
            if isempty(this.qf.classifierName)
                ...
                trainingTitle='Reference<br>population';
                testTitle=[this.qf.classifierName '<br> population'];
            end

            [html, ttl, generated]=QfHiDM.DecisionMatrix(this.qf, ...
