...
if vaxis=='x'
    ...
    a=r;
    [v,th,resnorm,Z_p] = curveFit(x_centre,y_centre,a,x,y,z);
elseif vaxis=='y'
    [x_centre, y_centre, r, sq_error] = circleFit ( [x;z] );
    fprintf('vaxis is y default\n');
    a=r;
    [v,th,resnorm,Z_p] = curveFit(x_centre,y_centre,a,y,x,z);
elseif vaxis=='z'
    [x_centre, y_centre, r, sq_error] = circleFit ( [x;y] );
    fprintf('vaxis is z default\n');
    a=r;
    [v,th,resnorm,Z_p] = curveFit(x_centre,y_centre,a,z,x,y);
else
    [x_centre, y_centre, r, sq_error] = circleFit ( [y;z] );
    centre(1,1)=x_centre;
    centre(1,2)=y_centre;
