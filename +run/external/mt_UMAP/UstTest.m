            ...
            if isempty(args)
                ...
                for loD = 1:nLoDs
                    ...
                    if ~exist(tmpltFile, 'file')
                        ...
                        reduced = run_umap_main(dataSet(trainingSetIdxs, :), ...
                            'label_column', 'end', ...
                            'parameter_names', cn, ...
                                            ...
                                            if ~exist(template, 'file')
                                                if args.ust_test_synthesize > 0
                                                    ...
                                                    [syntheticData, syntheticLabels] = ...
                                                        ...
                                                        dataSet(:, 1:end-1), dataSet(:, end), ...
                                                        synRows);
                                                    run_umap_main([syntheticData, syntheticLabels], ...
                                                        'parameter_names', cn, ...
