...
if ismember(1, whichOnes)
    ...
    run_umap_main;
    disp('run_umap_main Example 1 completed with no MATLAB exceptions!');
end
if ismember(2, whichOnes)
    disp('run_umap_main Example 2 starting...');
    run_umap_main('sample30k.csv', 'save_template_file', 'utBalbc2D.mat', 'verbose', verbose);
    disp('run_umap_main Example 2 completed with no MATLAB exceptions!');
end
if ismember(3, whichOnes)
    disp('run_umap_main Example 3 starting...');
    run_umap_main('sample130k.csv', 'template_file', 'utBalbc2D.mat', 'verbose', verbose);
    disp('run_umap_main Example 3 completed with no MATLAB exceptions!');
end
if ismember(4, whichOnes)
    disp('run_umap_main Example 4 starting...');
    run_umap_main('sampleBalbcLabeled55k.csv', 'label_column', 11, 'label_file', 'balbcLabels.properties', 'save_template_file', 'ustBalbc2D.mat', 'verbose', verbose);
    disp('run_umap_main Example 4 completed with no MATLAB exceptions!');
end
...
if ismember(8, whichOnes)
    disp('run_umap_main Example 8 starting...');
    run_umap_main('sample130k.csv', 'template_file', 'utBalbc3D.mat', 'verbose', verbose);
    disp('run_umap_main Example 8 completed with no MATLAB exceptions!');
end
...
if ismember(11, whichOnes)
    ...
    run_umap_main('sample30k.csv', 'template_file', 'ustRag2D.mat', 'method', 'Java', 'joined_transform', true, 'verbose', verbose);
    disp('run_umap_main Example 11 completed with no MATLAB exceptions!');
end
if ismember(12, whichOnes)
    disp('run_umap_main Example 12 starting...');
    run_umap_main('sampleRag148k.csv', 'template_file', 'ustBalbc2D.mat', 'qf_tree', true, 'qf_dissimilarity', true, 'see_training', true, 'verbose', verbose);
    disp('run_umap_main Example 12 completed with no MATLAB exceptions!');
end
if ismember(13, whichOnes)
    disp('run_umap_main Example 13 starting...');
...
if ismember(14, whichOnes)
    ...
    run_umap_main('sampleBalbcLabeled55k.csv', 'label_column', 11, 'label_file', 'balbcLabels.properties', 'save_template_file', 'ustBalbc2D.mat', 'verbose', verbose);
    disp('run_umap_main Example 14 (just MEX) completed with no MATLAB exceptions!');
end
if ismember(15, whichOnes)
    disp('run_umap_main Example 15 starting (just MEX first)...');
    run_umap_main('sampleRag55k.csv', 'template_file', 'ustBalbc2D.mat', 'verbose', verbose);
    disp('run_umap_main Example 15 (just MEX) completed with no MATLAB exceptions!');
end
if ismember(14, whichOnes)
    disp('run_umap_main Example 14 starting (with Python)...');
    run_umap_main('sampleBalbcLabeled55k.csv', 'label_column', 11, 'label_file', 'balbcLabels.properties', 'python', true, 'save_template_file', 'pyUstBalbc2D.mat', 'verbose', verbose);
    disp('run_umap_main Example 14 (with Python) completed with no MATLAB exceptions!');
end
if ismember(15, whichOnes)
...
if ismember(17, whichOnes)
    disp('run_umap_main Example 17 starting...');
    run_umap_main('sampleBalbcLabeled12k.csv', 'template_file', 'ustBalbc2D.mat', 'label_column', 'end', 'label_file', 'balbcLabels.properties', 'match_scenarios', 4, 'verbose', verbose, 'see_training', true, 'color_file', 'colorsByName.properties');
...
if ismember(20, whichOnes)
    disp('run_umap_main Example 20 starting...first with NO nndescent accleration');
    tic;
    run_umap_main('cytofExample.csv', 'nn_descent_min_rows', 0, 'verbose', verbose);
    toc;
    disp('slow half of Example 20 completed with no MATLAB exceptions!');
    tic;
    disp('run_umap_main Example 20 now WITH nndescent accleration');
    run_umap_main('cytofExample.csv', 'verbose', verbose);
    disp('run_umap_main Example 20 completed with no MATLAB exceptions!');
    toc;
end
