...
%   License: BSD 3 clause
    ...
    properties
        ...
        spellFile;
        spellProps; % maintain correct spelling since props uses lowercase
        ...
        map;%key: lowercase name; value: numeric color 0 to 1
        backupFile;
    end
    ...
    methods
        ...
        function color=get(this, key, idx, nIdxs, fnTranslate)
            ...
            %map is guaranteed to have ONLY contains lowercase keys
