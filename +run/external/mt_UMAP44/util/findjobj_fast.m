% Downloaded from MATLAB File Exchange as part of the findjobj submission by
% Yair M Altman at
...
% $Revision: 1.3 $  $Date: 2022/03/16 09:04:07 $
function jControl = findjobj_fast(hControl, jContainer)
    ...
    try jControl = hControl.JavaFrame.getGUIDEView; return, catch, end  %#ok<*JAVFM> % bail-out for HG2 matlab.ui.container.Panel 
