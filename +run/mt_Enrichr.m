...
background = string({'NSUN3','POLRMT','NLRX1','SFXN5','ZC3H12C','SLC25A39','ARSG',...
...
background_str = strjoin(background, newline);

formData = MultipartFormProvider('background', background_str);
request = RequestMessage('post', [], formData);

response = send(request, URI(base_url));

backgrd_id = response.Body.Data.backgroundid;
