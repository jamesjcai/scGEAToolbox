...
if ~(ismcc || isdeployed)
    ...
    pth0 = fullfile(pw1, 'external', 'mt_Specter');
    pth1 = fullfile(pw1, 'external', 'mt_Specter', 'dimred');
    pth2 = fullfile(pw1, 'external', 'mt_Specter', 'LSC');
    pth3 = fullfile(pw1, 'external', 'mt_Specter', 'utils');
    addpath(pth0);
    addpath(pth1);
    addpath(pth2);
    addpath(pth3);
