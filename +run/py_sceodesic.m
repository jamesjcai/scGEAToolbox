function [succeeded] = py_sceodesic(sce, wkdir, isdebug)
% https://github.com/rohitsinghlab/sceodesic

    succeeded = false;
    extprogname = 'py_sceodesic';
    ...
    if isvalid(fw)
        ...
        pause(0.5);
        gui.gui_waitbar(fw, [], [], 'Running py\_sceodesic...');
    end
