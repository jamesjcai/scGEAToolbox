function [reduction, umap, clusterIdentifiers, extras]=run_umap_main(varargin)
...
%
%   OUTPUT ARGUMENTS
%   Invoking run_umap_main returns these values:
...
%
%   Invoke run_umap_main with no arguments to download CSV files that 
...
%                           'kdtree'
%                               Instructs run_umap_main to use knnsearch with
...
%                           'nn_descent'
%                               Instructs run_umap_main to use KnnFind.Approximate 
...
%
%   'randomize'             true/false.  If false run_umap_main invokes
...
%                           instance of the UMAP class that run_umap_main
...
%                           reproducibility. run_umap_main prechecks the
...
%                           Default is 'MEX'.
%
%  'progress_callback'      A MATLAB function handle that run_umap_main
...
%                           progress_report here in run_umap_main.m exemplifies
%                           how to write a callback.
%                           Default is the function progress_report
%                           in run_umap_main.m.
%
%   'ask_to_save_template'  true/false instructs run_umap_main to ask/not ask
...
%                           if 'dbscan arguments' then run_umap_main uses the 
...
%                           then run_umap_main replaces with 'dbscan arguments'.
...
%                           can also save run_umap_main's 2nd output argument.
%                           Default is [].
%
...
%                           Default is false.
%                           run_umap_main only consults this argument when it
...
%                           described above.  If true then run_umap_main shows
...
%                           run_umap_main uses F-measure metric to compare 
...
%                           provided as arguments ro run_umap_main.  This 
...
%
%       run_umap_main('sample30k.csv', 'save_template_file', 'utBalbc2D.mat');
%
%   3.  Reduce parameters for sample130k.csv using prior template.
%
%       run_umap_main('sample130k.csv', 'template_file', 'utBalbc2D.mat');
%
...
%
%       run_umap_main('sampleBalbcLabeled55k.csv', 'label_column', 11, 'label_file', 'balbcLabels.properties', 'save_template_file', 'ustBalbc2D.mat');
%
...
%       cells.
%
%       run_umap_main('sampleRag148k.csv', 'template_file', 'ustBalbc2D.mat', 'match_supervisors', 1);
%
%   6.  Reduce parameters for sample30k.csv and return & plot cluster 
%       identifiers using density-based merging described at 
%       http://cgworkspace.cytogenie.org/GetDown2/demo/dbm.pdf.
%
%       [~,~, clusterIds]=run_umap_main('sample30k.csv', 'cluster_output', 'graphic');
%
%   7.  Repeat sample 2 but for 3D output and return cluster identifiers
%       and save the result as 3D template.
%
%       [~, ~, clusterIds]=run_umap_main('sample30k.csv', 'n_components', 3, 'save_template_file', 'utBalbc3D.mat');
%
%   8.  Repeat example 3 in 3D.
%
%       run_umap_main('sample130k.csv', 'template_file', 'utBalbc3D.mat');
%
...
%
%       run_umap_main('sampleRagLabeled60k.csv', 'label_column', 11, 'label_file', 'ragLabels.properties', 'save_template_file', 'ustRag2D.mat');
%
...
%
%       run_umap_main('sample30k.csv', 'template_file', 'ustRag2D.mat');
%
%   11. Repeat example 10 but use joined_transform.  Currently 'method'==
%       'Java' is the only support for this.
%
%        run_umap_main('sample30k.csv', 'template_file', 'ustRag2D.mat', 'method', 'Java', 'joined_transform', true);
%
%   12. Run example 5 again showing training/test set plot pair, QF tree
%       and QF dissimilarity plots.
%
%       run_umap_main('sampleRag148k.csv', 'template_file', 'ustBalbc2D.mat', 'qf_tree', true, 'qf_dissimilarity', true, 'see_training', true);
%
%   13. Compare our implementation to the original Python implementation by
%       repeating example 2 as follows.
%       
%       run_umap_main('sample30k.csv');
%       run_umap_main('sample30k.csv', 'python', true);
%
%   14. Compare our implementation with MEX method to the original Python 
%       implementation by repeating example 4 as follows.
%
%       run_umap_main('sampleBalbcLabeled55k.csv', 'label_column', 11, 'label_file', 'balbcLabels.properties', 'save_template_file', 'ustBalbc2D.mat');
%       run_umap_main('sampleBalbcLabeled55k.csv', 'label_column', 11, 'label_file', 'balbcLabels.properties', 'python', true, 'save_template_file', 'pyUstBalbc2D.mat');
%
%   15. Compare our implementation to the original Python 
%       implementation by repeating example 5 as follows.
%
%       run_umap_main('sampleRag148k.csv', 'template_file', 'ustBalbc2D.mat');
%       run_umap_main('sampleRag148k.csv', 'template_file', 'pyUstBalbc2D.mat');
%
%   16. Combining aspects of previous examples, this one creates
%       a UMAP supervised template for 3D output, then applies this
%       template to a different example. The final run_umap_main returns all
...
%
%       run_umap_main('sampleBalbcLabeled55k.csv', 'label_column', 11, 'label_file', 'balbcLabels.properties', 'qf_tree', true, 'n_components', 3, 'save_template_file', 'ustBalbc3D.mat');
%       [reduction, umap, clusterIdentifiers,extras]=run_umap_main('sample10k.csv', 'template_file', 'ustBalbc3D.mat', 'qf_tree', true, 'qf_dissimilarity', true, 'see_training', true, 'cluster_output', 'graphic');
%
...
%
%       run_umap_main('sampleBalbcLabeled12k.csv', 'template_file', 'ustBalbc2D.mat', 'label_column', 'end', 'label_file', 'balbcLabels.properties',  'match_scenarios', 4,  'see_training', true);
%
%   18. Same as example 17 but add a false positive/negative plot
%
%       run_umap_main('sampleBalbcLabeled12k.csv', 'template_file', 'ustBalbc2D.mat', 'label_column', 'end', 'label_file', 'balbcLabels.properties',  'match_scenarios', 4, 'match_histogram_fig', false, 'see_training', true, 'false_positive_negative_plot', true);
%
...
%
%       run_umap_main('s1_samusikImported_29D.csv', 'label_column', 'end', 'label_file', 's1_29D.properties', 'n_components', 3, 'save_template_file', 'ust_s1_samusikImported_29D_15nn_3D.mat');
%       run_umap_main('s2_samusikImported_29D.csv', 'template_file', 'ust_s1_samusikImported_29D_15nn_3D.mat', 'label_column', 'end', 'label_file', 's2_samusikImported_29D.properties', 'match_scenarios', [1 2 4],  'match_histogram_fig', false, 'see_training', true, 'false_positive_negative_plot', true, 'match_supervisors', [3 1 4]);
%
...
%
%        run_umap_main('cytofExample.csv', 'nn_descent_min_rows', 0);
%               
%        WITH acceleration
%   
%       run_umap_main('cytofExample.csv');
%
...
%
%       run_umap_main('s1_samusikImported_29D.csv', 'metric', 'minkowski', 'P', 1.8, 'label_column', 'end', 'label_file', 's1_29D.properties', 'n_components', 3, 'save_template_file', 'ust_s1_samusikImported_minkowski_1.80_29D_15nn_3D.mat');
...
if isequal(pwd, curPath)
    ...
    if ~isempty(prev) && false
        msg(Html.Wrap(['<b><center><font size="6" color="red">Can not use '...
            'run_umap_main!</font></center></b><br>You must remove AutoGate '...
