...
%
%   Verbosity               - Verbosity of the output generated by the GPT-5 family of models.
%                             "auto" (default) | "low" | "medium" | "high"
%
%   ReasoningEffort         - Amount of internal reasoning generated by the GPT-5 family of models.
%                             "auto" (default) | "none" | "minimal" | "low" | "medium" | "high" | "xhigh"
%
%
%   azureChat Functions:
    ...
    methods
        function this = azureChat(systemPrompt, nvp)
            arguments
                ...
                nvp.ReasoningEffort          (1,1) string {mustBeReasoningEffort} = "auto"
            end
        ...
        function [text, message, response] = generate(this, messages, nvp)
            ...
            arguments
                ...
                nvp.Verbosity           (1,1) string {mustBeVerbosity} = this.Verbosity
                nvp.ReasoningEffort     (1,1) string {mustBeReasoningEffort} = this.ReasoningEffort
            end
            ...
            try
                [text, message, response] = llms.internal.callAzureChatAPI(this.Endpoint, ...
                    ...
                    Verbosity=nvp.Verbosity, ReasoningEffort=nvp.ReasoningEffort, ...
    ...
    methods(Access=protected)
        function groups = getPropertyGroups(obj)
            props = struct( ...
                ...
                'FunctionNames', obj.FunctionNames, ...
                'ResponseFormat', obj.ResponseFormat, ...
                'TimeOut', obj.TimeOut);
            if obj.Verbosity ~= "auto"
                props.Verbosity = obj.Verbosity;
            end
            if obj.ReasoningEffort ~= "auto"
                props.ReasoningEffort = obj.ReasoningEffort;
            end
...
function mustBeVerbosity(value)
    mustBeMember(value,llms.openai.verbosityValues);
end

function mustBeReasoningEffort(value)
    mustBeMember(value,llms.openai.reasoningEffortValues);
end
