...
methods(Static)
    function old = usingOlderThan(target)
        try
            old = isMATLABReleaseOlderThan(target);
        catch
            releaseToVersion = containers.Map( ...
                {'R2016a','R2016b','R2017a','R2017b','R2018a','R2018b','R2019a','R2019b',...
                    'R2020a','R2020b','R2021a','R2021b','R2022a','R2022b','R2023a','R2023b','R2024a','R2024b'}, ...
                {'9.0','9.1','9.2','9.3','9.4','9.5','9.6','9.7',...
                    '9.8','9.9','9.10','9.11','9.12','9.13','9.14','23.2','24.1','24.2'} ...  
            );
            targetVersion = releaseToVersion(target);
            old = verLessThan('MATLAB', targetVersion);
        end
    end

    function yes=Is2019a
        yes = MatBasics.usingOlderThan('R2019b') && ~MatBasics.usingOlderThan('R2019a');
    end
