classdef CRY < quantum.internal.gate.gates.ControlledQubitGate
    ...
    methods
        function obj = CRY(controlQubit, targetQubit, theta)
        ...
        function obj = inv(obj)
            obj = quantum.internal.gate.gates.CRY(obj.controlQubit, obj.targetQubit, -obj.theta);
        end
    end
    ...
    methods(Hidden)
        function [instr, def, map] = getQASM(obj, Unpack, map, SupportedGates, varargin)
            ...
            if isKey(SupportedGates, obj.type) 
                ...
                gates = [ryGate(2,obj.theta/2) cxGate(1,2) ryGate(2,-obj.theta/2) cxGate(1,2)];
