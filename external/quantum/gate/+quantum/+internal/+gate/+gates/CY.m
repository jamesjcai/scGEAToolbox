classdef CY < quantum.internal.gate.gates.ControlledQubitGate
    ...
    methods
        function obj = CY(controlQubit, targetQubit)
    ...
    methods(Hidden)
        function [instr, def, map] = getQASM(obj, Unpack, map, SupportedGates, varargin)
            ...
            if isKey(SupportedGates, obj.type) 
                ...
                gates = [siGate(2) cxGate(1,2) sGate(2)];
