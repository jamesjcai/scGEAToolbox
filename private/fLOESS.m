...
for i = 1:n
    ...
    XX = [sum(w_.*x_.^0, "omitnan"), sum(w_.*x_.^1, "omitnan"), sum(w_.*x_.^2, "omitnan"); ...
        sum(w_.*x_.^1, "omitnan"), sum(w_.*x_.^2, "omitnan"), sum(w_.*x_.^3, "omitnan"); ...
        sum(w_.*x_.^2, "omitnan"), sum(w_.*x_.^3, "omitnan"), sum(w_.*x_.^4, "omitnan")];

    YY = [sum(w_.*y_.*(x_.^0), "omitnan"); ...
        sum(w_.*y_.*(x_.^1), "omitnan"); ...
        sum(w_.*y_.*(x_.^2), "omitnan")];
