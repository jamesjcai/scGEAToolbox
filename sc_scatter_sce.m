...
i_addmenu(m_net,0,@callback_scPCNet1,'GRN Construction - PC Regression (w/o subsampling) 🐢...');
i_addmenu(m_net,0,@callback_scTenifoldNet1,'GRN Construction - PC Regression (w/ subsampling) 🐢🐢 ...');
...
i_addmenu(m_net,0,@callback_scTenifoldXct,'Cell-Cell Interactions (CCIs) - scTenifoldXct (Python) 🐢🐢 ...');
i_addmenu(m_net,0,@callback_scTenifoldXct2,'Differential CCIs - scTenifoldXct (Python) 🐢🐢🐢 ...');
