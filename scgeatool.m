    ...
    function menus = createMenus(FigureHandle, id)
        switch id
            ...
            case 8
                ...
                in_addmenu(menus, 0, @in_DecontX, 'Detect Ambient RNA Contamination (DecontX/ℝ) [PMID:32138770]...');
            ...
            case 9
                ...
                %in_addmenu(menus, 1, {@(~,~) gui.sc_simpleabout(FigureHandle)}, 'About SCGEATOOL');
                majneedupdate = false;
                try
